...
set_property PACKAGE_PIN {AV15} [get_ports {sdio_spi_clk}]
set_property IOSTANDARD {LVCMOS18} [get_ports {sdio_spi_clk}]
set_property PACKAGE_PIN {AY15} [get_ports {sdio_spi_cs}]
set_property IOSTANDARD {LVCMOS18} [get_ports {sdio_spi_cs}]
set_property PACKAGE_PIN {AW15} [get_ports {sdio_spi_dat_0}]
set_property IOSTANDARD {LVCMOS18} [get_ports {sdio_spi_dat_0}]
set_property PACKAGE_PIN {AV16} [get_ports {sdio_spi_dat_1}]
set_property IOSTANDARD {LVCMOS18} [get_ports {sdio_spi_dat_1}]
set_property PACKAGE_PIN {AU16} [get_ports {sdio_spi_dat_2}]
set_property IOSTANDARD {LVCMOS18} [get_ports {sdio_spi_dat_2}]
set_property PACKAGE_PIN {AY14} [get_ports {sdio_spi_dat_3}]
